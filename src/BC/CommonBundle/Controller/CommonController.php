...
namespace BC\CommonBundle\Controller;
...
abstract class CommonController extends Controller {
    ...
    public function successRedirect($id = null) {
        return $this->get('bc.manager')->successRedirect($id, $this->getRouteShow(), $this->getRouteIndex());
    }
    ...
    /**
     * Propocionar el manager de la entidad, si lo tiene, sino con devolver bc.manager está bien, sino null.
     * @return Manager
     */
...
//        $func();
    ...
    public function isXmlHttpRequest() {
        return $this->get('bc.manager')->isXmlHttpRequest();
    }
    ...
    public function renderJson($data, $status = 200, $headers = array()) {
        return $this->get('bc.manager')->renderJson($data, $status, $headers);
    }

    /**
     * Devuelve un objeto del GenericLangRepository para las traducciones
     * @return \BC\CommonBundle\Service\GenericLangRepository|object
     */
    public function glr() {
        return $this->get('bc.glr');
    }
    ...
    public function serializeJSON($data) {
        return $this->get('bc.manager')->serializeJSON($data);
    }
}
