...
use BC\CommonBundle\Form\NomenclatureType;
...
abstract class NomenclatureController extends CommonController implements EntityNameExtension {
    ...
    public function getManager() {
        return $this->get('bc.nomenclature.manager');
    }
...
//        );
    ...
    private function newViewForInvalidData($data, $isValid = []) {
        ...
        $this->get('bc.entitysetter')->fromData($entity, $data);
    ...
    public function editAction(Request $request, $id) {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            $existe = $this->get('bc.entitysetter')->fromData($entity, $data);
