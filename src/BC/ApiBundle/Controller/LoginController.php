...
class LoginController extends FOSRestController {
    ...
    private function getRequest() {
        return $this->get('bc.manager')->getRequest();
    }
    ...
    private function findResultFromCuidador() {
        ...
        if (!empty($message)) {
            ...
            $em = $this->getDoctrine()->getManager();
            $completamiento = $this->get('bc.cuidador.manager')->calcPerfilCompletamiento($cuidador->getId());
            ...
            if ($cuidador->getIsDeleted()) {
                ...
                $estado = $em->getReference(Entity::CUIDADOR_ESTADO_ALTA, $this->getParameter('bc.cea.aceptado'));
