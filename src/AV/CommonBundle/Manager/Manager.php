...
class Manager {
    ...
    /**
     * @return null|object|\AV\CommonBundle\Entity\Lang
     * @throws \Exception
     */
    ...
    public function isVersionEs() {
        return $this->getParameter('av.version.despliegue') == $this->getParameter('av.version.es');
    }

    public function isVersionGb() {
        return $this->getParameter('av.version.despliegue') == $this->getParameter('av.version.gb');
    }
}